    ...
    <div class="container">
        ...
        <ul class="lnb-menu">
          ...
          <li class="sub on">
            ...
            <ul class="lnb-menu-sub" style="display: block">
              <li><a class="active">Sales Commision Settlement</a></li>
              <li><router-link to="/admin/scsc">Sales Settlement Commision Completed</router-link></li>
            </ul>
          </li>
        </ul>
      </aside>
      <div class="content">
        <div class="content-tit">
          ...
          <h2 class="tit">Sales Commision Settlement</h2>
          <ul class="navigation">
            <li>HOME</li>
            <li>ADMIN</li>
            <li>Sales Commision Settlement</li>
          </ul>
        </div>
          ...
          <div class="search-area">
            <ul class="search-list">
              ...
              <li class="fix">
                <strong>Date:</strong>
                <span class="input-style">
                  <input v-model="startDate" type="text" placeholder="2024-01-01" class="datepicker" />
                </span>
                <em>~</em>
                <span class="input-style">
                  <input v-model="endDate" type="text" placeholder="2024-12-31" class="datepicker" />
                </span>
              </li>
            </ul>
